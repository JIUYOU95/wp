...
<?php if ( is_home() || is_front_page() ) { ?><title><?php bloginfo('name'); ?> <?php echo zm_get_option('connector')?> <?php bloginfo('description'); ?><?php if (get_query_var('paged')) { echo ' - 第';  echo get_query_var('paged'); echo '页';}?></title><?php } ?>

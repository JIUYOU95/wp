...
?>
	...
	<p><?php _e( '下面的所有设置都可以在每个代码块的基础上进行配置，但是您可以在这里控制所有代码块的默认值.', 'syntaxhighlighter' ); ?></p>
...
?>
	...
	<ul class="ul-disc">
		<li><?php printf( _x( '%1$s or %2$s &#8212; 语言语法高亮显示。您可以交替使用该标签，如 <code>[php]code[/php]</code>. <a href="%3$s">点击这里</a> 有效标签的列表 (在下面 &quot;别名&quot;).', 'language parameter', 'syntaxhighlighter' ), '<code>lang</code>', '<code>language</code>', 'http://alexgorbatchev.com/wiki/SyntaxHighlighter:Brushes' ); ?></li>
		<li><?php printf( _x( '%s &#8212; 切换自动URL链接.', 'autolinks parameter', 'syntaxhighlighter' ), '<code>autolinks</code>' ); ?></li>
